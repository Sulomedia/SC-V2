...
public static String  _service_destroy() throws Exception{
 ...
 //BA.debugLineNum = 32;BA.debugLine="StopService(cmodul)";
anywheresoftware.b4a.keywords.Common.StopService(processBA,(Object)(mostCurrent._cmodul.getObject()));
 //BA.debugLineNum = 33;BA.debugLine="End Sub";
return "";
}
public static String  _service_start(anywheresoftware.b4a.objects.IntentWrapper _startingintent) throws Exception{
 //BA.debugLineNum = 18;BA.debugLine="Sub Service_Start (StartingIntent As Intent)";
 //BA.debugLineNum = 19;BA.debugLine="StartService(cmodul)";
anywheresoftware.b4a.keywords.Common.StartService(processBA,(Object)(mostCurrent._cmodul.getObject()));
