...
public class cmodul extends  android.app.Service{
	public static class cmodul_BR extends android.content.BroadcastReceiver {

		@Override
		public void onReceive(android.content.Context context, android.content.Intent intent) {
			android.content.Intent in = new android.content.Intent(context, cmodul.class);
			if (intent != null)
	...
	public void onCreate() {
        ...
        mostCurrent = this;
        if (processBA == null) {
		    processBA = new BA(this, null, null, "sclean2.com", "sclean2.com.cmodul");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			processBA.raiseEvent2(null, true, "CREATE", true, "sclean2.com.cmodul", processBA, _service, anywheresoftware.b4a.keywords.Common.Density);
		}
        if (!false && ServiceHelper.StarterHelper.startFromServiceCreate(processBA, false) == false) {
            ...
            BA.LogInfo("*** Service (cmodul) Create ***");
    ...
    private void handleStart(android.content.Intent intent) {
    	BA.LogInfo("** Service (cmodul) Start **");
	...
	public void onDestroy() {
        super.onDestroy();
        BA.LogInfo("** Service (cmodul) Destroy **");
...
public static String  _cb_oncleancompleted(long _cachesize) throws Exception{
 //BA.debugLineNum = 132;BA.debugLine="Sub cb_onCleanCompleted(CacheSize As Long)";
 //BA.debugLineNum = 133;BA.debugLine="Log(CacheSize&\" cleaned\")";
anywheresoftware.b4a.keywords.Common.Log(BA.NumberToString(_cachesize)+" cleaned");
 //BA.debugLineNum = 134;BA.debugLine="kvst.DeleteAll";
_kvst._deleteall();
 //BA.debugLineNum = 135;BA.debugLine="kvsdata.Put(\"cz\",FormatFileSize(CacheSize))";
_kvsdata._put("cz",(Object)(_formatfilesize((float) (_cachesize))));
 //BA.debugLineNum = 137;BA.debugLine="End Sub";
return "";
}
public static String  _cb_oncleanstarted() throws Exception{
 //BA.debugLineNum = 127;BA.debugLine="Sub cb_onCleanStarted";
 //BA.debugLineNum = 129;BA.debugLine="Log(\"Cleaning..\")";
...
int _n = 0;
 //BA.debugLineNum = 87;BA.debugLine="Sub cb_onScanCompleted(AppsList As Object)";
 //BA.debugLineNum = 88;BA.debugLine="Dim totalsize As Long = 0";
_totalsize = (long) (0);
 //BA.debugLineNum = 89;BA.debugLine="Dim pm As PackageManager";
_pm = new anywheresoftware.b4a.phone.PackageManagerWrapper();
 //BA.debugLineNum = 90;BA.debugLine="Private icon As BitmapDrawable";
_icon = new anywheresoftware.b4a.objects.drawable.BitmapDrawable();
 //BA.debugLineNum = 91;BA.debugLine="piclist.Clear";
_piclist.Clear();
 //BA.debugLineNum = 92;BA.debugLine="obj.Clear";
_obj.Clear();
 //BA.debugLineNum = 93;BA.debugLine="alist.DeleteAll";
_alist._deleteall();
 //BA.debugLineNum = 95;BA.debugLine="Try";
try { //BA.debugLineNum = 96;BA.debugLine="Dim lu As List = AppsList";
_lu = new anywheresoftware.b4a.objects.collections.List();
_lu.setObject((java.util.List)(_appslist));
 //BA.debugLineNum = 99;BA.debugLine="For n = 0 To lu.Size-1";
{
final int step9 = 1;
final int limit9 = (int) (_lu.getSize()-1);
_n = (int) (0) ;
for (;(step9 > 0 && _n <= limit9) || (step9 < 0 && _n >= limit9) ;_n = ((int)(0 + _n + step9))  ) {
 //BA.debugLineNum = 100;BA.debugLine="app= lu.Get(n)";
_app = (Object[])(_lu.Get(_n));
 //BA.debugLineNum = 101;BA.debugLine="If app(1) = \"com.android.systemui\"  Then  Conti";
if ((_app[(int) (1)]).equals((Object)("com.android.systemui"))) { 
if (true) continue;};
 //BA.debugLineNum = 102;BA.debugLine="icon = pm.GetApplicationIcon(app(1))";
_icon.setObject((android.graphics.drawable.BitmapDrawable)(_pm.GetApplicationIcon(BA.ObjectToString(_app[(int) (1)]))));
 //BA.debugLineNum = 103;BA.debugLine="totalsize = totalsize+app(2)";
_totalsize = (long) (_totalsize+(double)(BA.ObjectToNumber(_app[(int) (2)])));
 //BA.debugLineNum = 104;BA.debugLine="alist.Put(app(1),totalsize+app(2))";
_alist._put(BA.ObjectToString(_app[(int) (1)]),(Object)(_totalsize+(double)(BA.ObjectToNumber(_app[(int) (2)]))));
 //BA.debugLineNum = 105;BA.debugLine="obj.Add(app(1))";
_obj.Add(_app[(int) (1)]);
 //BA.debugLineNum = 106;BA.debugLine="kvsdata.PutBitmap(app(1),icon.Bitmap)";
_kvsdata._putbitmap(BA.ObjectToString(_app[(int) (1)]),(anywheresoftware.b4a.objects.drawable.CanvasWrapper.BitmapWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.drawable.CanvasWrapper.BitmapWrapper(), (android.graphics.Bitmap)(_icon.getBitmap())));
 //BA.debugLineNum = 107;BA.debugLine="qbase.Remove(\"com.android.systemui\")";
_qbase._remove("com.android.systemui");
 }
};
 } 
       catch (Exception e20) {
			processBA.setLastException(e20); //BA.debugLineNum = 110;BA.debugLine="Log(LastException.Message)";
...
if (_lu.getSize()>0) { 
 //BA.debugLineNum = 113;BA.debugLine="Log(\"T-Size: \"&FormatFileSize(totalsize))";
anywheresoftware.b4a.keywords.Common.Log("T-Size: "+_formatfilesize((float) (_totalsize)));
 //BA.debugLineNum = 114;BA.debugLine="kvsdata.Put(\"cz\",FormatFileSize(totalsize))";
_kvsdata._put("cz",(Object)(_formatfilesize((float) (_totalsize))));
 //BA.debugLineNum = 115;BA.debugLine="CallSub(Main,\"c_start\")";
anywheresoftware.b4a.keywords.Common.CallSubNew(processBA,(Object)(mostCurrent._main.getObject()),"c_start");
 }else {
 //BA.debugLineNum = 117;BA.debugLine="Log(\"nothing to show\")";
anywheresoftware.b4a.keywords.Common.Log("nothing to show");
 //BA.debugLineNum = 118;BA.debugLine="CallSub(Main,\"finish_modul\")";
...
public static String  _cb_onscanprogress(int _current,int _total) throws Exception{
 //BA.debugLineNum = 81;BA.debugLine="Sub cb_onScanProgress(Current As Int , Total As In";
 //BA.debugLineNum = 82;BA.debugLine="kvsdata.Put(\"to\",Total)";
_kvsdata._put("to",(Object)(_total));
 //BA.debugLineNum = 83;BA.debugLine="kvsdata.Put(\"c\",Current)";
_kvsdata._put("c",(Object)(_current));
 //BA.debugLineNum = 84;BA.debugLine="CallSub(Main,\"update_modul\")";
...
public static String  _cb_onscanstarted() throws Exception{
 //BA.debugLineNum = 75;BA.debugLine="Sub cb_OnScanStarted";
 //BA.debugLineNum = 76;BA.debugLine="Log(\"Started\")";
...
double _si = 0;
int _i = 0;
 //BA.debugLineNum = 139;BA.debugLine="Sub FormatFileSize(Bytes As Float) As String";
 //BA.debugLineNum = 140;BA.debugLine="Private Unit() As String = Array As String(\" Byte";
_unit = new String[]{" Byte"," KB"," MB"," GB"," TB"," PB"," EB"," ZB"," YB"};
 //BA.debugLineNum = 141;BA.debugLine="If Bytes = 0 Then";
if (_bytes==0) { 
 //BA.debugLineNum = 142;BA.debugLine="Return \"0 Bytes\"";
if (true) return "0 Bytes";
 }else {
 //BA.debugLineNum = 144;BA.debugLine="Private Po, Si As Double";
_po = 0;
_si = 0;
 //BA.debugLineNum = 145;BA.debugLine="Private I As Int";
_i = 0;
 //BA.debugLineNum = 146;BA.debugLine="Bytes = Abs(Bytes)";
_bytes = (float) (anywheresoftware.b4a.keywords.Common.Abs(_bytes));
 //BA.debugLineNum = 147;BA.debugLine="I = Floor(Logarithm(Bytes, 1024))";
_i = (int) (anywheresoftware.b4a.keywords.Common.Floor(anywheresoftware.b4a.keywords.Common.Logarithm(_bytes,1024)));
 //BA.debugLineNum = 148;BA.debugLine="Po = Power(1024, I)";
_po = anywheresoftware.b4a.keywords.Common.Power(1024,_i);
 //BA.debugLineNum = 149;BA.debugLine="Si = Bytes / Po";
_si = _bytes/(double)_po;
 //BA.debugLineNum = 150;BA.debugLine="Return NumberFormat(Si, 1, 2) & Unit(I)";
...
int _i = 0;
 //BA.debugLineNum = 64;BA.debugLine="Sub info_remote";
 //BA.debugLineNum = 65;BA.debugLine="apli=pack.GetInstalledPackages";
_apli = _pack.GetInstalledPackages();
 //BA.debugLineNum = 66;BA.debugLine="kvst.Put(\"ta\",apli.Size)";
_kvst._put("ta",(Object)(_apli.getSize()));
 //BA.debugLineNum = 67;BA.debugLine="qbase.DeleteAll";
_qbase._deleteall();
 //BA.debugLineNum = 68;BA.debugLine="For i = 0 To apli.Size-1";
{
final int step4 = 1;
final int limit4 = (int) (_apli.getSize()-1);
_i = (int) (0) ;
for (;(step4 > 0 && _i <= limit4) || (step4 < 0 && _i >= limit4) ;_i = ((int)(0 + _i + step4))  ) {
 //BA.debugLineNum = 69;BA.debugLine="qbase.Put(i,apli.Get(i))";
_qbase._put(BA.NumberToString(_i),_apli.Get(_i));
 }
};
 //BA.debugLineNum = 71;BA.debugLine="Log(\"added: \"&kvst.Get(\"ta\"))";
...
_dir = anywheresoftware.b4a.keywords.Common.File.getDirInternal()+"/Bdata";
 //BA.debugLineNum = 18;BA.debugLine="Private kvst,kvsdata,alist,dbase,abase,qbase As K";
...
_abase._initialize(processBA,anywheresoftware.b4a.keywords.Common.File.getDirInternal(),"abase_data");
 //BA.debugLineNum = 34;BA.debugLine="qbase.Initialize(File.DirInternal,\"qbase_data\")";
_qbase._initialize(processBA,anywheresoftware.b4a.keywords.Common.File.getDirInternal(),"qbase_data");
 //BA.debugLineNum = 36;BA.debugLine="piclist.Initialize";
_piclist.Initialize();
 //BA.debugLineNum = 37;BA.debugLine="obj.Initialize";
_obj.Initialize();
 //BA.debugLineNum = 38;BA.debugLine="cb.initialize(\"cb\")";
_cb.initialize("cb",processBA);
 //BA.debugLineNum = 39;BA.debugLine="cts.Initialize";
_cts.Initialize(processBA);
 //BA.debugLineNum = 40;BA.debugLine="apli.Initialize";
_apli.Initialize();
 //BA.debugLineNum = 41;BA.debugLine="apli=pack.GetInstalledPackages";
_apli = _pack.GetInstalledPackages();
 //BA.debugLineNum = 42;BA.debugLine="counter=0";
_counter = (int) (0);
 //BA.debugLineNum = 43;BA.debugLine="t2.Initialize(\"t2\",1000)";
...
_t3.Initialize(processBA,"t3",(long) (1000));
 //BA.debugLineNum = 45;BA.debugLine="t3.Enabled=False";
_t3.setEnabled(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 46;BA.debugLine="If Not(File.IsDirectory(File.DirInternal,\"Bdata\")";
if (anywheresoftware.b4a.keywords.Common.Not(anywheresoftware.b4a.keywords.Common.File.IsDirectory(anywheresoftware.b4a.keywords.Common.File.getDirInternal(),"Bdata"))) { 
 //BA.debugLineNum = 47;BA.debugLine="File.MakeDir(File.DirInternal,\"Bdata/temp\")";
anywheresoftware.b4a.keywords.Common.File.MakeDir(anywheresoftware.b4a.keywords.Common.File.getDirInternal(),"Bdata/temp");
 //BA.debugLineNum = 48;BA.debugLine="File.WriteList(dir,\"clist.txt\",obj)";
...
public static String  _service_destroy() throws Exception{
 ...
 //BA.debugLineNum = 57;BA.debugLine="t2.Enabled=False";
...
public static String  _start() throws Exception{
 ...
 //BA.debugLineNum = 61;BA.debugLine="cb.ScanCache";
_cb.ScanCache();
 //BA.debugLineNum = 62;BA.debugLine="End Sub";
return "";
}
public static String  _start_c() throws Exception{
 //BA.debugLineNum = 123;BA.debugLine="Sub start_c";
 //BA.debugLineNum = 124;BA.debugLine="cb.CleanCache";
_cb.CleanCache();
 //BA.debugLineNum = 125;BA.debugLine="Log(\"start_c:\")";
